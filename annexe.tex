...
\markboth{Décors}{Peintures, mosaïques, reliefs}
\newcommand{\decor}[2][]{
  {
    \setkeys{bdd}{#1}
    \centering
...
\hline 
\multicolumn{2}{|p{0.37\textwidth}|}{\emph{Iliade} en entier} & 1 &  &  &  &  &  &  & 1\tabularnewline
\hline 
\multicolumn{2}{|p{0.37\textwidth}|}{Chryséis (embarquement de)} & 1 &  &  &  &  &  &  & 1\tabularnewline
\hline 
...
\markboth{Objets}{Tablettes, sculptures et art toreutique}
\newcommand{\objet}[2][]{
  {
    \setkeys{bdd}{#1}
...
\newcommand{\monnaie}[2][]{
  ...
  \begin{tabular}{>{\small}p{0.6\textwidth} p{0.4\textwidth}}
